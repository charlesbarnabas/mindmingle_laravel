...
@section('title', 'Data Class Type | Mind Mingle')
@section('content')
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3">Data Class Types</h1>
		<nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
				<li class="breadcrumb-item active" aria-current="page">Categories</li>
				<li class="breadcrumb-item active" aria-current="page">Class Types</li>
			</ol>
		</nav>
		@if (session('message'))
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="button text-lg-start text-center my-2">
							<a href="{{ route('admin.class-types.create') }}" class="btn btn-success mb-2"><i
									class="fas fa-puzzle-piece me-2"></i>New Class Type
							</a>
						</div>
										...
										<thead>
											<tr>
												<th class="sorting sorting_asc" tabindex="0" aria-controls="datatables-column-search-text-inputs"
													...
													aria-label="Class Type Name: activate to sort column descending" style="width: 179px;">Class Type Name</th>
												<th class="sorting" tabindex="0" aria-controls="datatables-column-search-text-inputs" rowspan="1"
													colspan="1" aria-label="Class Type Slug: activate to sort column ascending" style="width: 179px;">Class
													Type Slug
													Slug</th>
										...
										<tfoot>
											<tr>
												<th rowspan="1" colspan="1">
													<input type="text" class="form-control" placeholder="Search Class Type Name">
												</th>
												<th rowspan="1" colspan="1">
													<input type="text" class="form-control" placeholder="Search Class Type Slug">
												</th>
												<th rowspan="1" colspan="1">
...
@push('custom-script')
	...
	<script src="{{ asset('assets-admin/js/page/dataTableClassType.js') }}"></script>
