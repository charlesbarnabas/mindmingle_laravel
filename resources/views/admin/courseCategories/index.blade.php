...
@section('title', 'Data Course Categories | Mind Mingle')
@section('content')
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3">Data Course Categories</h1>
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="button text-lg-start text-center my-2">
							<a href="{{ route('admin.course-categories.create') }}" class="btn btn-success mb-2"><i
									class="fas fa-puzzle-piece me-2"></i>New
								Category</a>
						</div>
									...
									<table id="datatables-column-search-text-inputs" class="table table-striped dataTable" style="width: 100%;"
										...
										<tfoot>
											<tr>
												...
												<th rowspan="1" colspan="1">
													<input type="text" class="form-control" placeholder="Search Category Slug">
												</th>
												<th rowspan="1" colspan="1">
...
@push('custom-script')
	...
	<script src="{{ asset('assets-admin/js/page/dataTableCourseCategory.js') }}"></script>
