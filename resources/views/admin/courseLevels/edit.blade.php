...
@section('title', 'Edit Masterclass Level | Mind Mingle')
@section('content')
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3">Edit Masterclass Level</h1>
			...
			<div class="col-6">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Edit Masterclass level</h5>
						<h6 class="card-subtitle text-muted">The data must be valid.</h6>
					</div>
					<div class="card-body">
						<form class="form" runat="server"
							action="{{ route('admin.course-levels.update', $masterclassLevels->masterclass_level_slug) }}" method="POST">
							@csrf
							@method('PUT')
							<input type="hidden" name="masterclass_level_id" value="{{ $masterclassLevels->masterclass_level_id }}">
							<div class="row">
								<div class="col-8 ">
									<div class="mb-3">
										...
										<input type="text" class="form-control @error('masterclass_level_name') is-invalid @enderror"
											id="formGroupExampleInput" name="masterclass_level_name"
											value="{{ $masterclassLevels->masterclass_level_name }}" placeholder="Input Masterclass level name" required>
								...
								<div class="col-8 ">
									<div class="mb-3">
										...
										<input type="text" class="form-control @error('masterclass_level_slug') is-invalid @enderror"
											id="formGroupExampleInput" name="masterclass_level_slug"
											value="{{ $masterclassLevels->masterclass_level_slug }}" placeholder="Input Masterclass level slug" required>
