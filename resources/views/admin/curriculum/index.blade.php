...
@section('title', 'Data Curriculum| Mind Mingle')

@section('content')

	<div class="container-fluid p-0">
		<h1 class="h3 mb-3">Curriculum</h1>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Curriculum on {{ $masterclasses->masterclass_name }}</h5>
					</div>

					<div class="card-body">
						<div class="button text-lg-start text-center my-2">
							<a
								href="{{ route('admin.masterclass.curriculum-section.curriculum.create', ['masterclass' => $masterclasses->masterclass_slug, 'curriculum_section' => $curriculums->curriculum_section_id]) }}"
										...
										<thead>
											<tr>
												<th class="sorting sorting_asc" tabindex="0" aria-controls="datatables-column-search-text-inputs"
													...
													aria-label="Curriculum Name: activate to sort column descending" style="width: 179px;">Curriculum
													Name</th>
												<th class="sorting sorting_asc" tabindex="0" aria-controls="datatables-column-search-text-inputs"
													rowspan="1" colspan="1" aria-sort="ascending"
													aria-label="Curriculum Description: activate to sort column descending" style="width: 179px;">Curriculum
													Description</th>
										...
										<tfoot>
											<tr>
												<th rowspan="1" colspan="1">
													<input type="text" class="form-control" placeholder="Search Curriculum Name">
												</th>
												<th rowspan="1" colspan="1">
...
@push('custom-script')
	...
	<script src="{{ asset('assets-admin/js/page/dataTableCurriculum.js') }}"></script>
