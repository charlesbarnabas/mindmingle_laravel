...
@section('title', 'Data Price Type | Mind Mingle')
@section('content')
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3">Data Price Types</h1>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Price Types</h5>
					</div>
					<div class="card-body">
						<div class="button text-lg-start text-center my-2">
							<a href="{{ route('admin.price-types.create') }}" class="btn btn-success mb-2"><i
									class="fas fa-puzzle-piece me-2"></i>New Price Type
							</a>
						</div>
										...
										<thead>
											<tr>
												<th class="sorting sorting_asc" tabindex="0" aria-controls="datatables-column-search-text-inputs"
													...
													aria-label="Class Type Name: activate to sort column descending" style="width: 179px;">Price Type Name</th>
												<th class="sorting" tabindex="0" aria-controls="datatables-column-search-text-inputs" rowspan="1"
													colspan="1" aria-label="Class Type Slug: activate to sort column ascending" style="width: 179px;">Price
													Type Slug</th>
										...
										<tfoot>
											<tr>
												<th rowspan="1" colspan="1">
													<input type="text" class="form-control" placeholder="Search Price Type Name">
												</th>
												<th rowspan="1" colspan="1">
													<input type="text" class="form-control" placeholder="Search Price Type Slug">
												</th>
												<th rowspan="1" colspan="1">
...
@push('custom-script')
	...
	<script src="{{ asset('assets-admin/js/page/dataTablePriceType.js') }}"></script>
