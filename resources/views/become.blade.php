			...
			<div class="container position-relative">
				<div class="row g-4 align-items-center">
					<div class="col-md-6">
						...
						<p>Mind Mingle is looking for passionate and knowledgeable individuals to become instructors. Share your expertise in areas like coding, design, and more with eager learners. 
							As an instructor, you'll have the opportunity to help shape the next generation of professionals while making a meaningful impact in the world of education.</p>
						<!-- Button -->
						<a href="#fill-instructor-form" class="btn btn-warning mb-0">Start Teaching today</a>
					</div>

					<div class="col-md-6 text-center">
						<!-- Image -->
						<img src="{{ asset('assets/images/element/28.svg') }}" class="h-300px h-xl-400px" alt="">
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				...
				<div class="row mb-4">
					<div class="col-sm-10 col-xl-6 text-center mx-auto">
						<h2>Guide with Mind Mingle</h2>
						<p class="mb-0">Share your expertise and passion for learning with others. Mind Mingle helps you grow as an 
							instructor and reach students eager to enhance their skills in areas like coding, design, and more. 
							With our platform, you can make a real difference while advancing your career.</p>
					</div>
				</div>
				...
				<div class="row g-4 g-md-5">
					...
					<div class="col-md-4 text-center">
						<img src="{{ asset('assets/images/element/create-account.svg') }}" class="h-200px" alt="">
						<h4 class="mt-3">Create Account</h4>
						<p class="text-truncate-2 mb-0">Sign up easily to start teaching on Mind Mingle and showcase your expertise.</p>
					</div>

					<!-- Item -->
					<div class="col-md-4 text-center">
						<img src="{{ asset('assets/images/element/add-course.svg') }}" class="h-200px" alt="">
						<h4 class="mt-3">Add Course</h4>
						<p class="text-truncate-2 mb-0">Create courses with videos, e-books, and quizzes to help students achieve their goals.</p>
					</div>

					<!-- Item -->
					<div class="col-md-4 text-center">
						<img src="{{ asset('assets/images/element/earn-money.svg') }}" class="h-200px" alt="">
						<h4 class="mt-3">Earn Money</h4>
						<p class="text-truncate-2 mb-0">Earn based on performance and premium features like private chats and exclusive content.</p>
					</div>
				</div> <!-- Row END -->
			</div>
		</section>
				...
				<div class="bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden">
					...
					<div class="row g-4 position-relative align-items-center justify-content-center">
						...
						<div class="col-sm-6 col-lg-3 text-center">
							<div class="d-flex justify-content-center">
								<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0"
									data-purecounter-end="89" data-purecounter-delay="200" data-purecounter-duration="0">
									10</h4>
						...
						<div class="col-sm-6 col-lg-3 text-center">
							<div class="d-flex justify-content-center">
								<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0"
									data-purecounter-end="25" data-purecounter-delay="200" data-purecounter-duration="0">
									1.3</h4>
								<span class="display-6 text-orange mb-0">K</span>
							</div>
						...
						<div class="col-sm-6 col-lg-3 text-center">
							<div class="d-flex justify-content-center">
								<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0"
									data-purecounter-end="180" data-purecounter-delay="200" data-purecounter-duration="0">150</h4>
					...
					<div class="col-lg-5 position-relative mt-xl-0" id="fill-instructor-form">
						...
						<div class="card card-body shadow p-4">
							...
							<form class="row g-3 mt-2 position-relative z-index-9">
								...
								<!-- Button -->
								<div class="col-12">
									<button type="submit" class="btn btn-warning mb-0">Submit form</button>
								</div>
							</form>
							<!-- Form END -->
						</div>
					...
					<div class="col-lg-7 z-index-9 mt-5 mt-xl-0">
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade show active" id="course-pills-1" role="tabpanel" aria-labelledby="course-pills-tab-1">
								...
								<p>Join Mind Mingle as an instructor and share your expertise with eager learners. Create courses in fields such as design, coding, and more, and help students achieve their learning goals. It's an opportunity to make a difference while building your teaching career.</p>
								<p>Whether you're an experienced professional or a passionate learner, Mind Mingle provides the tools to create engaging lessons. Add videos, quizzes, and e-books to your course, and start teaching today.</p>
								<p>Ready to inspire the next generation of learners? Start your journey as an instructor on Mind Mingle and enjoy the flexibility of teaching on your own schedule.</p>
							</div>

							<!-- Content -->
							<div class="tab-pane fade" id="course-pills-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
								<h6>Role of Instructor</h6>
								<p>As an instructor on Mind Mingle, your role is to create engaging and informative courses that help students succeed. 
									You'll have the flexibility to choose the topics you're most passionate about, whether it’s coding, design, or other fields.</p>

								<!-- Info -->
								<ul class="list-group list-group-borderless mb-3">
									<li class="list-group-item">
										<i class="fas fa-check-circle text-success me-2"></i>Create courses using videos, e-books, and quizzes.
									</li>
									<li class="list-group-item d-flex">
										<i class="fas fa-check-circle text-success me-2 mt-1"></i>Engage directly with students through forums and premium features like private chats.
									</li>
									<li class="list-group-item">
										<i class="fas fa-check-circle text-success me-2"></i>Earn money based on performance and engagement.
									</li>
								</ul>
							</div>
							...
							<div class="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
								<h6>Start with a Course</h6>
								<p>Creating a course on Mind Mingle is simple and intuitive. Upload videos, create quizzes, and add e-books to build a comprehensive learning experience. Whether you're teaching beginners or advanced learners, you can design courses that suit your teaching style.</p>
								<p><img src="{{ asset('assets/images/element/instructor-course.svg') }}" class="rounded float-start me-3 h-200px my-3" alt="Course creation">Our platform provides all the tools you need to start teaching, including course management features, learner tracking, and more. Share your knowledge with students worldwide, and make an impact on their educational journey.</p>
								<p>Start creating your first course today and become part of the Mind Mingle community, where learners and instructors connect for mutual growth.</p>
							</div>
						</div>
						<!-- Tab contents END -->
					</div>
