...
@section('content')
			...
			<div class="container">
				...
				<div class="row align-items-center g-5">
					...
					<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
						...
						<!-- Title -->
						<h1 class="mb-0 display-6">Develop your skills at
							<span class="position-relative">Mind Mingle
								<!-- SVG START -->
								<span class="position-absolute top-50 start-50 translate-middle ms-3 z-index-n1">
									<svg width="300px" height="62.1px" enable-background="new 0 0 366 62.1" viewBox="0 0 366 62.1"
						...
						<!-- Content -->
						<p class="my-4 lead">Mind Mingle is an educational program, we are aware of the skill gap between academics and
							industry and want to
							contribute to improving the capabilities of Indonesian IT personnel who are ready to be absorbed
							by the industry.</p>

						<!-- Info -->
						<div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start mb-5">
							<!-- Button -->
							<a href="{{ route('courses') }}" class="btn btn-lg btn-warning me-2 mb-4 mb-sm-0">View Masterclass
								Program</a>
						</div>
					</div>
					<!-- Left content END -->
					...
					<div class="col-lg-7 col-xl-6 text-center position-relative">
						...
						<figure class="position-absolute bottom-0 start-50 translate-middle-x mt-4 mb-0">
							<svg width="550px" height="538px" viewBox="0 0 554 544" style="enable-background:new 0 0 554 544;"
								xml:space="preserve">
						...
						<div class="position-relative">
							<img src="{{ asset('assets/images/element/08.png') }}" alt="">
						</div>
					</div>
					<!-- Right content END -->
				</div>
				...
				<div class="row g-4">
					...
					<div class="col-sm-6 col-xl-3">
						<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
							...
							<div class="ms-4 h6 fw-normal">
								<div class="d-flex">
									<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="2"
										data-purecounter-delay="200">0</h5>
								</div>
								<p class="mb-0">Class Available</p>
							</div>
						</div>
					</div>
					<!-- Counter item -->
					<div class="col-sm-6 col-xl-3">
						<div class="d-flex justify-content-center align-items-center p-4 bg-blue bg-opacity-10 rounded-3">
							...
							<div class="ms-4 h6 fw-normal">
								<div class="d-flex">
									<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="3"
					...
					<div class="col-sm-6 col-xl-3">
						<div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
							...
							<div class="ms-4 h6 fw-normal">
								<div class="d-flex">
									<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="50"
										data-purecounter-delay="200">0</h5>
								</div>
								<p class="mb-0">Graduate of</p>
							</div>
						</div>
					</div>
					<!-- Counter item -->
			...
			<div class="container">
				...
				<div class="row mb-4">
					<div class="col-lg-8 mx-auto text-center">
						<h2 class="fs-1">Class Available</h2>
				...
				<div class="tab-content" id="course-pills-tabContent">
					...
					<div class="tab-pane fade show active" id="course-pills-tabs-1" role="tabpanel"
						...
						<div class="row g-4">
							...
							{{-- <!-- Image --> --}}
							{{-- <img src="{{ Storage::url($class->masterclass->masterclass_thumbnail) }}" --}}
							{{-- class="card-img-top @if (time() > strtotime($class->tanggal_kelas . ' 23:59:00')) inactive-class @endif" --}}
							{{-- alt="course image"> --}}
							{{-- <!-- Card body --> --}}
							...
							{{-- <a href="#" --}}
							{{-- class="badge bg-success bg-opacity-10 text-success">{{ $class->masterclass->masterclass_level }}</a> --}}
							{{-- @if (time() > strtotime($class->tanggal_kelas . ' 23:59:00')) --}}
							{{-- <a href="#" class="badge bg-danger bg-opacity-10 text-danger">Pendaftaran --}}
							{{-- Sudah Tutup</a> --}}
							{{-- @endif --}}
							{{-- </div> --}}
							{{-- <!-- Title --> --}}
							{{-- <h5 class="card-title fw-normal"><a --}}
							{{-- href="/masterclass/{{ $class->class_id }}/{{ str_replace(" ","-",strtolower($class->masterclass->masterclass_name)) }}">{{ $class->masterclass->masterclass_name }}</a> --}}
							{{-- </h5> --}}
							{{-- <p class="mb-2 text-truncate-2"></p> --}}
							{{-- <p class="mb-2 text-truncate-2">{{ $class->masterclass->masterclass_short_desc }}</p> --}}
							{{-- </div> --}}
							{{-- <!-- Card footer --> --}}
							...
							{{-- class="far fa-clock text-danger me-2"></i>{{ date('d F Y', strtotime($class->tanggal_kelas)) }}</span> --}}
							{{-- <span class="h6 fw-light mb-0"><i --}}
							{{-- class="fas fa-table text-orange me-2"></i>24 Materi</span> --}}
							{{-- </div> --}}
							{{-- </div> --}}
							{{-- </div> --}}
							{{-- </div> --}}
							...
							<div class="row position-relative">
								...
								<div class="col-11 mx-auto position-relative">
									<div class="row align-items-center">
										<!-- Title -->
										<div class="col-lg-7">
											<h3 class="text-white">Join Instructor!</h3>
											<p class="text-white mb-3 mb-lg-0">Share knowledge and spread the benefits by
												joining as an Instructor at Mind Mingle</p>
										</div>
										<!-- Content and input -->
										<div class="col-lg-5 text-lg-end">
											<a href="{{ route('become.instructor') }}" class="btn btn-outline-warning mb-0">Become an
												Instructor</a>
										</div>
									</div>
								</div>
	...
	{{-- <div class="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover mt-2 mt-sm-5">
		<div class="tiny-slider-inner " data-arrow="true" data-dots="false" data-items-xl="6" data-items-lg="5"
			data-items-md="4" data-items-sm="3" data-items-xs="2">
			<!-- Slider items -->
