						...
						<div class="col-lg-10 col-xl-6">
							<div class="card shadow p-2">
								<div class="row g-0">
									<!-- Image -->
									<div class="col-md-4">
										<img src="{{ asset('assets/images/instructor/01.jpg') }}" class="rounded-3" alt="...">
									</div>
						...
						<div class="col-lg-10 col-xl-6">
							<div class="card shadow p-2">
								<div class="row g-0">
									<!-- Image -->
									<div class="col-md-4">
										<img src="{{ asset('assets/images/instructor/02.jpg') }}" class="rounded-3" alt="...">
									</div>
						...
						<div class="col-lg-10 col-xl-6">
							<div class="card shadow p-2">
								<div class="row g-0">
									<!-- Image -->
									<div class="col-md-4">
										<img src="{{ asset('assets/images/instructor/03.jpg') }}" class="rounded-3" alt="...">
									</div>
						...
						<div class="col-lg-10 col-xl-6">
							<div class="card shadow p-2">
								<div class="row g-0">
									<!-- Image -->
									<div class="col-md-4">
										<img src="{{ asset('assets/images/instructor/04.jpg') }}" class="rounded-3" alt="...">
									</div>
									...
									<div class="col-md-8">
										<div class="card-body">
											...
											<div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
												<div>
													<h5 class="card-title mb-0"><a href="#">Frances Guerrero</a>
													</h5>
						...
						<div class="col-lg-10 col-xl-6">
							<div class="card shadow p-2">
								<div class="row g-0">
									<!-- Image -->
									<div class="col-md-4">
										<img src="{{ asset('assets/images/instructor/06.jpg') }}" class="rounded-3" alt="...">
									</div>
						...
						<div class="col-lg-10 col-xl-6">
							<div class="card shadow p-2">
								<div class="row g-0">
									<!-- Image -->
									<div class="col-md-4">
										<img src="{{ asset('assets/images/instructor/07.jpg') }}" class="rounded-3" alt="...">
									</div>
						...
						<div class="col-lg-10 col-xl-6">
							<div class="card shadow p-2">
								<div class="row g-0">
									<!-- Image -->
									<div class="col-md-4">
										<img src="{{ asset('assets/images/instructor/08.jpg') }}" class="rounded-3" alt="...">
									</div>
						...
						<div class="col-lg-10 col-xl-6">
							<div class="card shadow p-2">
								<div class="row g-0">
									<!-- Image -->
									<div class="col-md-4">
										<img src="{{ asset('assets/images/instructor/09.jpg') }}" class="rounded-3" alt="...">
									</div>
...
@endsection
@push('custom-script')
	<script src="{{ asset('assets/vendor/dist/purecounter_vanilla.js') }}"></script>
@endpush
