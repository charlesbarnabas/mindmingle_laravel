	...
	<div class="row mb-4">
		...
		<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
			<div class="d-flex justify-content-center align-items-center p-4 bg-orange bg-opacity-15 rounded-3">
				...
				<div class="ms-4">
					<div class="d-flex">
						<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="9" data-purecounter-delay="200">
							0</h5>
					</div>
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<!-- Image -->
									<div class="w-100px">
										<img src="{{ asset('assets/images/courses/4by3/03.jpg') }}" class="rounded" alt="">
									</div>
									<div class="mb-0 ms-2">
										<!-- Title -->
										...
										<div class="overflow-hidden">
											...
											<div class="progress progress-sm bg-primary bg-opacity-10">
												<div class="progress-bar bg-primary aos aos-init aos-animate" role="progressbar" data-aos="slide-right"
													data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 100%"
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<!-- Image -->
									<div class="w-100px">
										<img src="{{ asset('assets/images/courses/4by3/05.jpg') }}" class="rounded" alt="">
									</div>
									<div class="mb-0 ms-2">
										<!-- Title -->
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center">
									<!-- Image -->
									<div class="w-100px">
										<img src="{{ asset('assets/images/courses/4by3/02.jpg') }}" class="rounded" alt="">
									</div>
									<div class="mb-0 ms-2">
										<!-- Title -->
